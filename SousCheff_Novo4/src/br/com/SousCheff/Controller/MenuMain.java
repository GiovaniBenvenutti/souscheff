...
//	=================================================================================================================
	...
	public static String buscaSugestão(List<Receita> lista, JCheckBox chckbxAlmSeg, JCheckBox chckbxAlmTer,
		...
		String sugestao = "		Sugestões de Receitas: \n";
		String refeicao = "";
		...
		if (chckbxAlmSeg.isSelected() == false && chckbxAlmTer.isSelected() == false
			...
			if (chckbxAlmSeg.isSelected()) {
				refeicao = "AlmSeg";
				sugestao += ("	Almoço de segunda-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxAlmTer.isSelected()) {
				refeicao = "AlmTer";
				sugestao += ("	Almoço de Terça-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxAlmQua.isSelected()) {
				refeicao = "AlmQua";
				sugestao += ("	Almoço de Quarta-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxAlmQui.isSelected()) {
				refeicao = "AlmQui";
				sugestao += ("	Almoço de Quinta-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxAlmSex.isSelected()) {
				refeicao = "AlmSex";
				sugestao += ("	Almoço de Sexta-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxAlmSab.isSelected()) {
				refeicao = "AlmSab";
				sugestao += ("	Almoço de Sábado: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxAlmDom.isSelected()) {
				refeicao = "AlmDom";
				sugestao += ("	Almoço de Domingo: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxJanSeg.isSelected()) {
				refeicao = "JanSeg";
				sugestao += ("	Jantar de Segunda-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxJanTerça.isSelected()) {
				refeicao = "JanTer";
				sugestao += ("	Jantar de Terça-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxJanQuarta.isSelected()) {
				refeicao = "JanQua";
				sugestao += ("	Jantar de Quarta-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxJanQuinta.isSelected()) {
				refeicao = "JanQui";
				sugestao += ("	Jantar de Quinta-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxJanSexta.isSelected()) {
				refeicao = "JanSex";
				sugestao += ("	Jantar de Sexta-feira: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxJanSbado.isSelected()) {
				refeicao = "JanSab";
				sugestao += ("	Jantar de Sabado: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}

			if (chckbxJanDomingo.isSelected()) {
				refeicao = "JanDom";
				sugestao += ("	Jantar de Domingo: " + (pesquisaPorRefeição(lista, refeicao) + "\n"));
			}
		}
	...
	public static String pesquisaPorRefeição(List<Receita> lista, String refeicao) {
		String re = "";
		int indx = 0;
		...
		Receita aviso = new Receita("Cadastre uma receita para essa refeição. ", " ", " ", " ");
		if (temp.isEmpty()) {
			temp.add(aviso);
		}

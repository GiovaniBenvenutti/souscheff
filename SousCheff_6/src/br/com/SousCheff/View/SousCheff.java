	...
	public SousCheff() {
		...
		btnNewSugerir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textAreaTexto.setText(MenuMain.buscaSugestão(lista, chckbxAlmSeg, chckbxAlmTer, chckbxAlmQua,
						chckbxAlmQui, chckbxAlmSex, chckbxAlmSab, chckbxAlmDom, chckbxJanSeg, chckbxJanTerça,
						chckbxJanQuarta, chckbxJanQuinta, chckbxJanSexta, chckbxJanSbado, chckbxJanDomingo,
						chckbxSobremesa, chckbxDiversos));
			}
		});
